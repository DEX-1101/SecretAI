...
if __name__ == "__main__":
    ...
    commands2 = [
        ...
        ("cd {ui_path}/extensions && find . -mindepth 1 -maxdepth 1 -type d -print -exec git -C {} reset --hard && find . -mindepth 1 -maxdepth 1 -type d -print -exec git -C {} pull", "Updating Extensions")
